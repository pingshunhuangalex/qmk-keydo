 ...
 * `-------------------------------+-------+-------+-------.          ,-------+-------+-------+-------------------------------'
 *                                 |SET_NMM|SET_BSM| Ctrl  |          | Shift | Bksp  |SET_BSM|
 *                                 `-----------------------'          `-----------------------'
 */
#define LAYER_NMM \
 ...
 * |  Esc  |   ^   |   @   |   {   |   }   |   &   |                          |   !   |   ?   |   :   |   *   |   #   | Enter |
 * `-------------------------------+-------+-------+-------.          ,-------+-------+-------+-------------------------------'
 *                                 |SET_BSM|SET_BSM| Ctrl  |          | Shift | Bksp  |SET_SMM|
 *                                 `-----------------------'          `-----------------------'
 */
#define LAYER_SMM \
 ...
 * `-------------------------------+-------+-------+-------.          ,-------+-------+-------+-------------------------------'
 *                                 |SET_BSM|SET_BSM| Ctrl  |          | Shift |DEL_PWM|SET_BSM|
 *                                 `-----------------------'          `-----------------------'
 */
#define LAYER_NVM \
 ...
 * `-------------------------------+-------+-------+-------.          ,-------+-------+-------+-------------------------------'
 *                                 |SET_BSM|SET_BSM| Ctrl  |          | Shift | Bksp  |SET_BSM|
 *                                 `-----------------------'          `-----------------------'
 */
#define LAYER_FNM \
...
XXXXXXX, LYT_WIN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SET_FNM, \
                                    SET_NMM, SET_NVM, XXXXXXX,          XXXXXXX, SET_MKM, SET_SMM
