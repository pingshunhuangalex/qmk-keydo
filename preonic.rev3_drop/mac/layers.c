 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  | Left  | Right | Lower |SPC_NVM| Ctrl  | Shift |BSP_MKM| Raise | Down  |  Up   | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
#define LAYER_BSM \
...
KC_ESC,  KC_LEFT, KC_RGHT, OSL_NMM, SPC_NVM, KC_LCTL, OSM_SFT, BSP_MKM, OSL_SMM, KC_DOWN, KC_UP,   KC_ENT
 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  | Left  | Right |SET_NMM|SET_BSM| Ctrl  | Shift | Bksp  |SET_BSM| Down  |  Up   | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
#define LAYER_NMM \
...
_______, _______, _______, SET_NMM, SET_BSM, _______, _______, KC_BSPC, SET_BSM, _______, _______, _______
 ...
 * |  Esc  |   ^   |   @   |   {   |   }   |   &   |   !   |   ?   |   :   |   *   |   #   | Enter |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  | Left  | Right |SET_BSM|SET_BSM| Ctrl  | Shift | Bksp  |SET_SMM| Down  |  Up   | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
#define LAYER_SMM \
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
...
_______, _______, _______, SET_BSM, SET_BSM, _______, _______, KC_BSPC, SET_SMM, _______, _______, _______
 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  | Left  | Right |SET_BSM|SET_BSM| Ctrl  | Shift |DEL_PWM|SET_BSM| Down  |  Up   | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
#define LAYER_NVM \
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
...
_______, _______, _______, SET_BSM, SET_BSM, _______, _______, DEL_PWM, SET_BSM, _______, _______, _______
 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  | Left  | Right |SET_BSM|SET_BSM| Ctrl  | Shift | Bksp  |SET_BSM| Down  |  Up   | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
#define LAYER_FNM \
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
...
_______, _______, _______, SET_BSM, SET_BSM, _______, _______, KC_BSPC, SET_BSM, _______, _______, _______
 ...
 * |       |LYT_WIN|       |       |       |       |       |       |       |       |       |SET_FNM|
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |       |       |       |SET_NMM|SET_NVM|       |       |SET_MKM|SET_SMM|       |       |       |
 * `-----------------------------------------------------------------------------------------------'
 */
#define LAYER_LLM \
...
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
XXXXXXX, LYT_WIN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SET_FNM, \
XXXXXXX, XXXXXXX, XXXXXXX, SET_NMM, SET_NVM, XXXXXXX, XXXXXXX, SET_MKM, SET_SMM, XXXXXXX, XXXXXXX, XXXXXXX
