...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
  * |  Esc  | Left  | Right |  Alt  | Bksp  | Lower | Raise |SpaceFn| Shift |  Up   | Down  | Enter |
  * `-----------------------------------------------------------------------------------------------'
  */
  [_BASE] = LAYOUT_preonic_grid(
    ...
    KC_ESC,  KC_LEFT, KC_RGHT, KC_LALT, KC_BSPC, OSL_NUM, OSL_SYM, SPC_NAV, KC_LSFT, KC_UP,   KC_DOWN, KC_ENT
  ),
  ...
  * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
  * |  Esc  | Left  | Right |  Alt  | Bksp  | _NUM  | _SYM  | _NAV  | Shift |  Up   | Down  | Enter |
  * `-----------------------------------------------------------------------------------------------'
  */
  [_NUM] = LAYOUT_preonic_grid(
    ...
    _______, XXXXXXX, XXXXXXX, KC_P0,   KC_P1,   KC_P2,   KC_P3,   KC_PENT, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    _______, _______, _______, _______, _______, SET_NUM, _______, _______, _______, _______, _______, _______
  ),
  ...
  */
  [_SYM] = LAYOUT_preonic_grid(
    ...
    _______, _______, _______, _______, _______, _______, SET_SYM, _______, _______, _______, _______, _______
  ),
  ...
  */
  [_NAV] = LAYOUT_preonic_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, SET_NAV, _______, _______, _______, _______
  ),
  ...
  * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
  * |EEPRST | Prev  | Next  |  Alt  | Bksp  | _NUM  | _SYM  | _NAV  | Shift | Vol+  | Vol-  | Mute  |
  * `-----------------------------------------------------------------------------------------------'
  */
