...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | Lower |BS_LALT| Raise | Shift |SpaceFn|  Mk   | Down  |  Up   | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_BASE] = LAYOUT_preonic_grid(
        ...
        KC_ESC,  KC_LEFT, KC_RGHT, OSL_NUM, BS_LALT, OSL_SYM, OSM_SFT, SPC_NAV, OSL_MK,  KC_DOWN, KC_UP,   KC_ENT
    ),
    ...
    * |  GUI  |   /   |   *   |   -   |   +   |   (   |   )   |   .   |   ,   |   %   |   ^   | _BASE |
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | _NUM  |BS_LALT| _BASE | Shift | _BASE | _NAV  | Down  |  Up   | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_NUM] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, SET_NUM, _______, SET_BAS, _______, SET_BAS, SET_NAV, _______, _______, _______
    ),
    ...
    * |  GUI  |   ^   |   @   |   {   |   }   |   \   |   !   |   ?   |   :   |   #   |   ~   | _BASE |
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | _BASE |BS_LALT| _SYM  | Shift | _BASE | _BASE | Down  |  Up   | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_SYM] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, SET_BAS, _______, SET_SYM, _______, SET_BAS, SET_BAS, _______, _______, _______
    ),
    ...
    * |  GUI  |       |       |       |       |       |       |       |MWDown |       |       | _BASE |
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | _BASE |BS_LALT| _BASE | Shift | _BASE |  _MK  | Down  |  Up   | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_MK] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, SET_BAS, _______, SET_BAS, _______, SET_BAS, SET_MK,  _______, _______, _______
    ),

    /* Layer 4: NAVIGATION + NUMPAD (Space Fn)
    * ,-----------------------------------------------------------------------------------------------.
    * |       |       |       |       |       |       |   %   | NLCK  |   /   |   *   |   -   |  Del  |
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    ...
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | _BASE |BS_LALT| _BASE | Shift |   0   | Space |   .   | Enter | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_NAV] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, SET_BAS, _______, SET_BAS, _______, KC_P0,   KC_SPC,  KC_PDOT, KC_PENT, _______
    ),
    ...
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Prev  | Next  | _BASE |BS_LALT| _BASE | Shift | _BASE | _BASE | Vol-  | Vol+  | Mute  |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_FN] = LAYOUT_preonic_grid(
        ...
        _______, KC_MPRV, KC_MNXT, SET_BAS, _______, SET_BAS, _______, SET_BAS, SET_BAS, KC_VOLD, KC_VOLU, KC_MUTE
    )
};
