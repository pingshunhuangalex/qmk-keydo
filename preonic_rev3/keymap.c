...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_BASE] = LAYOUT_preonic_grid(
        ...
        KC_QUOT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_TAB,
    ...
    */
    [_NUM] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, SET_NUM, KC_BSPC, _______, _______, SET_BAS, SET_BAS, _______, _______, _______
    ),
    ...
    */
    [_SYM] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, SET_BAS, KC_BSPC, _______, _______, SET_BAS, SET_SYM, _______, _______, _______
    ),
    ...
    */
    [_MK] = LAYOUT_preonic_grid(
        ...
        SET_MK,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_D, XXXXXXX, XXXXXXX, _______,
    ...
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * | _NAV  |       |       |       |DEL_HOM|DEL_END|       |Rewind | Vol-  |Forward|       |  Tab  |
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | _BASE | Bksp  |  Alt  | Shift | _BASE | _BASE | Down  |  Up   | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_NAV] = LAYOUT_preonic_grid(
        ...
        SET_NAV, XXXXXXX, XXXXXXX, XXXXXXX, DEL_HOM, DEL_END, XXXXXXX, KC_MRWD, KC_VOLD, KC_MFFD, XXXXXXX, _______,
        _______, _______, _______, SET_BAS, KC_BSPC, _______, _______, SET_BAS, SET_BAS, _______, _______, _______
    ),
    ...
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  _FN  | Brt-  | Brt+  |  F11  |  F12  |       |       | Calc  | Print | Menu  | Pause |  Tab  |
    * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
    * |  Esc  | Left  | Right | _BASE | Bksp  |  Alt  | Shift | _BASE | _BASE | Down  |  Up   | Enter |
    * `-----------------------------------------------------------------------------------------------'
    */
    [_FN] = LAYOUT_preonic_grid(
        ...
        SET_FN,  KC_BRID, KC_BRIU, KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, KC_CALC, KC_PSCR, KC_APP,  KC_PAUS, _______,
        _______, _______, _______, SET_BAS, KC_BSPC, _______, _______, SET_BAS, SET_BAS, _______, _______, _______
    )
};
