 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | Lower |   Z   |   X   |   C   |   D   |   V   |   K   |   H   |   ,   |   .   |   /   | Raise |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  |  Fn   |  GUI  |  Alt  | Shift | Bksp  |SpaceFn| Left  | Down  |  Up   | Right | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
[_BASE] = LAYOUT_preonic_grid(
  ...
  OSL_NUM, KC_Z,   KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, OSL_SYM,
  KC_ESC,  OSL_FN, KC_LGUI, KC_LALT, KC_LSFT, KC_BSPC, SPC_NAV, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT
),
 ...
 * | _NUM  |       |       |       |   1   |   2   |   3   |   0   |   ,   |   .   |       | _SYM  |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  |  _FN  |  GUI  |  Alt  | Shift | Bksp  | _NAV  | Left  | Down  |  Up   | Right | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
[_NUM] = LAYOUT_preonic_grid(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_P1,   KC_P2,   KC_P3,   KC_P0,   KC_PCMM, KC_PDOT, XXXXXXX, SET_SYM,
  _______, SET_FN,  _______, _______, _______, _______, SET_NAV, _______, _______, _______, _______, _______
),
...
[_SYM] = LAYOUT_preonic_grid(
  ...
  SET_NUM, KC_GRV,  KC_TILD, KC_QUOT, KC_DQUO, KC_BSLS, KC_PIPE, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______,
  _______, SET_FN,  _______, _______, _______, _______, SET_NAV, _______, _______, _______, _______, _______
),
...
[_NAV] = LAYOUT_preonic_grid(
  ...
  SET_NUM, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SET_SYM,
  _______, SET_FN,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | _NUM  |  F11  |  F12  | Brt-  | Brt+  |       |EEPRST |       | Play  | Stop  | Mute  | _SYM  |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |  Esc  |  _FN  |  GUI  |  Alt  | Shift | Bksp  | _NAV  | Prev  | Vol-  | Vol+  | Next  | Enter |
 * `-----------------------------------------------------------------------------------------------'
 */
[_FN] = LAYOUT_preonic_grid(
  ...
  SET_NUM, KC_F11,  KC_F12,  KC_BRID, KC_BRIU, XXXXXXX, EEP_RST, XXXXXXX, KC_MPLY, KC_MSTP, KC_MUTE, SET_SYM,
  _______, _______, _______, _______, _______, _______, SET_NAV, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______
),
